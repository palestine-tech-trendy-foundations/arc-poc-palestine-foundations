...
Two self-guided, fully autograded modules for complete beginners, built for the **Palestine Tech Trendy** program under the **ARC** curriculum (DELTA v1.1 methodology).
...
| Python 3.10+ (Module 2 & 3) | Run `python3 --version`, should print `3.10` or higher | [python.org/downloads](https://www.python.org/downloads/) |
| A text editor | Any will do | [VS Code](https://code.visualstudio.com/) recommended, free |
| `pytest` installed (Module 2 & 3) | Run `pip install pytest` | Installs via pip, no account needed |
| `matplotlib` installed (Module 3 only) | Run `pip install matplotlib` | Installs via pip, no account needed |
...
| Module 3, Portfolio Project | [LESSON.md](./module-3-portfolio-project/LESSON.md) | [README.md](./module-3-portfolio-project/README.md) |

Work through the modules in order, each one assumes you're comfortable with everything before it. Module 3 is the finale: no fixed answer key, you choose your own data, and you finish with a small, real project you can actually link from your GitHub profile or CV.
...
- [ ] Read `module-3-portfolio-project/LESSON.md`
- [ ] Opened a Pull Request for Module 3, titled correctly, with all automated checks passing

All three Pull Requests should be left **open**, not merged, do not merge your own PRs.
